...
def config_parser(cmd=None):
    ...
    parser.add_argument("--crossval", type=str, default='NSFF',
                        help='Cross validation subset for NSFF data lists')
    ...
    parser.add_argument('--use_mvs_dy', action='store_true',
                        help='use MVS encoding volume to generalise dynamic scenes')
    ...
    parser.add_argument("--lambda_sf_smooth", type=float, default=0.1,
                        help='Scene flow smoothness loss coefficient')
    parser.add_argument("--lambda_sf_depth",   type=float, default=0.04,
